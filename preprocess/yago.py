...
if __name__ == '__main__':
    ...
    gen_yago_randomwalk(path='../data/freebase/',
                     walk_length=100,n_walks=40)

    # gen_homoadj(path='data/freebase/')

    # gen_edge_adj_random(path='data/freebase/',edge_dim=130)

    # gen_edge_sim_adj(path='data/freebase/', K=10, edge_dim=130,sim='cos')
